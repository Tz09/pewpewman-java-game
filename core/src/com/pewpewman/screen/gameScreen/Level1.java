...
public class Level1 extends AbstractScreen {
    ...
    public Level1(Pewpewman game) {
        ...
        floorTile1   = elementAtlas.findRegion("level1_tile1");
        floorTile2   = elementAtlas.findRegion("level1_tile2");
        wall         = elementAtlas.findRegion("level1_wall");
        obstacle     = elementAtlas.findRegion("level1_obstacle");
        ...
        int enemyStartX = Settings.MAP_CENTRE_X - 10;
        int enemyStartY;
        for (int i = 0; i < Settings.ENEMY_LEVEL1; i++) {
            if (i < 3) {
                enemyStartX += 5;
        ...
        // Enter text here
        openingBox.createStoryBoxUI("Hi Pewpewman,\n\n\n" +
                "are you ready to save the world?\n\n\n" +
                "If you are ready...\n\n\n" +
                "press X and your death shall come!!!!!\n\n\n" +
                "(Press SPACEBAR to attack)");
        endingBox.createStoryBoxUI("Unbelievable!!!\n\n\n" +
                "Now, be prepared...\n\n\n" +
